...
export default function ModernHero() {
    return (
        <div className="w-full min-h-[70vh] flex flex-col items-center justify-center bg-navy-void relative overflow-hidden border-b border-white/5 pt-20">
            {/* Background Decorative Grid */}
            <div className="absolute inset-0 z-0 opacity-20 pointer-events-none"
                style={{
                    backgroundImage: 'linear-gradient(to right, #101620 1px, transparent 1px), linear-gradient(to bottom, #101620 1px, transparent 1px)',
            ...
            <div className="z-10 text-center px-4">
                ...
                <div className="mt-4 flex items-center justify-center gap-4">
                    ...
                    <span className="font-title italic text-playgray-mid text-xl">Est. 1994</span>
                </div>
            </div>
            ...
            <div className="z-10 mt-16 w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 border-y border-white/10 bg-navy-dark/50 backdrop-blur-md">
                <div className="p-8 border-r border-white/10 flex flex-col items-center justify-center gap-2 group transition-colors hover:bg-white/[0.02]">
                    <span className="font-ui text-playgray-mid uppercase tracking-widest text-xs">Total Pins Down</span>
                ...
                <div className="p-8 border-r border-white/10 flex flex-col items-center justify-center gap-2 group transition-colors hover:bg-white/[0.02]">
                    <span className="font-ui text-playgray-mid uppercase tracking-widest text-xs">Strike Rate</span>
                ...
                <div className="p-8 flex flex-col items-center justify-center gap-2 group transition-colors hover:bg-white/[0.02]">
                    <span className="font-ui text-playgray-mid uppercase tracking-widest text-xs">Active Roster</span>
            ...
            {/* Bottom Tagline */}
            <div className="z-10 mt-8 font-title italic text-playgray-dark tracking-wide">
