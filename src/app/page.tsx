...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center bg-navy-dark text-white">
        ...
        <div className="flex flex-col gap-6 justify-center">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-4 border-t border-white/10 mt-4">
            <div className="flex flex-col">
              ...
              <span className="font-ui text-gray-mid uppercase tracking-wide">Active Roster</span>
            </div>
            <div className="h-10 w-px bg-white/10 mx-4" />
            <div className="flex flex-col">
              <span className="font-wordmark text-3xl text-navy-mid">14</span>
              <span className="font-ui text-gray-mid uppercase tracking-wide">Tournaments Won</span>
            </div>
          </div>
        </div>
        <div className="bg-navy rounded-xl border border-white/5 h-[400px] flex items-center justify-center relative overflow-hidden">
          {/* Placeholder for Club Image */}
          <div className="absolute inset-0 bg-gradient-to-tr from-navy-dark to-transparent opacity-80" />
          <p className="font-ui text-gray-dark text-2xl tracking-[4px] uppercase relative z-10">[ About Image Placeholder ]</p>
        </div>
      </section>
      ...
      <section id="performance" className="w-full bg-navy py-24 border-y border-white/5 relative overflow-hidden text-center">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col items-center">
          ...
          <p className="font-sans text-gray-mid max-w-2xl mx-auto mb-12 text-lg leading-relaxed">
      ...
      <section id="gallery" className="w-full max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-24">
          {/* Mock Gallery Grid */}
          <div className="bg-navy aspect-square rounded-lg border border-white/5 flex items-center justify-center"><span className="font-ui text-gray-dark">IMG_01</span></div>
          <div className="bg-navy aspect-square rounded-lg border border-white/5 flex items-center justify-center md:col-span-2 md:row-span-2"><span className="font-ui text-gray-dark">IMG_02 (HERO)</span></div>
          <div className="bg-navy aspect-square rounded-lg border border-white/5 flex items-center justify-center"><span className="font-ui text-gray-dark">IMG_03</span></div>
          <div className="bg-navy aspect-square rounded-lg border border-white/5 flex items-center justify-center"><span className="font-ui text-gray-dark">IMG_04</span></div>
          <div className="bg-navy aspect-square rounded-lg border border-white/5 flex items-center justify-center"><span className="font-ui text-gray-dark">IMG_05</span></div>
        </div>
      ...
      <footer className="w-full bg-navy-dark border-t-8 border-strike py-16">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="flex flex-col gap-2">
            ...
            <p className="font-ui text-gray-dark tracking-[3px] uppercase text-xs mt-4">Nairobi Central Center // Westgate Mall</p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end gap-4">
            ...
            <div className="font-ui text-xs text-gray-dark tracking-widest uppercase">
